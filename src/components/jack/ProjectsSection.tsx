...
function Card({
  ...
  return (
    ...
    >
      ...
      >
        {/* Top row */}
        <div className="flex items-center justify-between gap-4 flex-wrap pb-4 sm:pb-6 border-b border-[rgba(215,226,234,0.15)]">
          <div className="flex items-baseline gap-4 sm:gap-6 flex-wrap">
            ...
            <div className="flex flex-col">
              <span className="text-xs sm:text-sm text-[#D7E2EA]/60 font-medium uppercase tracking-wider">
                {project.category}
              </span>
              <h3 className="text-xl sm:text-2xl md:text-3xl font-medium uppercase text-[#D7E2EA] tracking-wide">
                {project.name}
              </h3>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-6 pt-4 sm:pt-6">
          ...
          <div className="md:col-span-7 rounded-[30px] sm:rounded-[40px] md:rounded-[50px] overflow-hidden bg-[#161616] min-h-[300px] md:min-h-full">
            <img
              src={project.col2Img}
